...
from employees.models.employees import Employees
from employees.serializers.employees import EmployeeSerializer
...
class EmployeeViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        qs = (
            Employee.objects.select_related("region", "province", "district")
            .all()
        )
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({'error': f'Error al actualizar al empleado: {str(e)}'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
