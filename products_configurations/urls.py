...
urlpatterns = [
    # Category
    path("category/paginated/", category_list_paginated, name="category_list_paginated"),
    ...
    # Proveedor
    path("supplier/paginated/", supplier_list_paginated, name="supplier_list_paginated"),
    ...
    # Marca
    path("brand/paginated/", brand_list_paginated, name="brand_list_paginated"),
    ...
    # Producto
    path("product/paginated/", product_list_paginated, name="product_list_paginated"),
